...
export default class Reference extends React.Component {
  state = {
    modalVisible1: false,   refresh: false,  visible4: false,Class:'',      selectedItem: '',
  }
componentDidMount(){
  radioItems.map(item => {
 ...
 this.setState({visible4: false,Class:filter});
  };
                  ...
                  <View style={{}}>
                                     ...
                                     <TouchableOpacity
                                       ...
                                       <View>
                                        ...
                                        {this.state.Class ? this.state.Class :' Select Occupation'}
                                         </Text>
                                       </View>
                                       <View>
                                         <Image
