      ...
      if (state.isConnected) {
        timeout(
          ...
          fetch('https://trivediservices.com/scholar/api.php', {
            ...
            if(res.response.intrest){
              InterestcheckData[0].value =res.response.intrests[0].merit_based,
              InterestcheckData[1].value=res.response.intrests[0].means_based
              InterestcheckData[2].value=res.response.intrests[0].cultural_talent
              InterestcheckData[3].value=res.response.intrests[0].visual_art
              InterestcheckData[4].value=res.response.intrests[0].literacy_art
              InterestcheckData[5].value=res.response.intrests[0].sport_talent
              InterestcheckData[6].value=res.response.intrests[0].science_maths_based
              InterestcheckData[7].value=res.response.intrests[0].technology_based
              for (let i = 0; i < InterestcheckData.length; i++) {
                if(InterestcheckData[i].value == '1'){
                  InterestcheckData[i].check = true
                }
              }
            }
                
                if(res.response.studentpersonalinfo){
                  if (res.response.studentpersonalinfo[0].gender == 'male') {
...
this.setState({
      ...
      Document: res.response.docs[0].doctype,
                ...
                if(res.response.education) {
                  if (res.response.education[0].is_your_present_class == '1') {
